...
<head
    ...
    <title>
        ...
        @endif {{ config('app.name', __('messages.layout.default_site_name')) }}
    </title>
    ...
    <meta property="og:title" content="@yield('og_title', config('app.name', __('messages.layout.default_site_name')))"/>
    <meta property="og:description" content="@yield('og_description', __('messages.layout.default_meta_description'))"/>
    <meta property="og:type" content="website"/>
    <meta property="og:url" content="@yield('og_url', request()->url())"/>
    <meta property="og:image" content="{{ asset('storage/' . setting('logo_file')) }}"/>
    <meta property="og:site_name" content="{{ config('app.name', __('messages.layout.default_site_name')) }}"/>
    <meta name="twitter:card" content="summary_large_image"/>
    <meta name="twitter:title" content="@yield('twitter_title', config('app.name', __('messages.layout.default_site_name')))"/>
    <meta name="twitter:description" content="@yield('twitter_description', __('messages.layout.default_meta_description'))"/>
...
<div id="affiliate-popup">
    ...
    <p>💡 {{ __('messages.layout.affiliate_suggestion') }}</p>
