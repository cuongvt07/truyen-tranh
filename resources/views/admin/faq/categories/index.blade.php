...
@section('template_title', 'FAQ Categories')
            ...
            <tbody>
                @forelse($categories as $cat)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('admin.faq.categories.edit', $cat->id) }}" class="btn btn-sm btn-info">
                                <i class="fas fa-edit"></i>
                            </a>
                            <form action="{{ route('admin.faq.categories.destroy', $cat->id) }}" method="POST" class="d-inline formDelete">
                                @csrf
                                @method('DELETE')
