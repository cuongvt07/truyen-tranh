...
<div class="container">
    <header class="header-manga" style="margin-bottom:14px">
        <div class="container" style="display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:10px">
            <h1><i class="fa fa-user-friends"></i> {{ __('messages.community.my_teams') }}</h1>
            <a href="{{ route('teams.create') }}" class="btn btn-primary"><i class="fa fa-plus"></i> {{ __('messages.community.create_team_btn') }}</a>
        </div>
    </header>
