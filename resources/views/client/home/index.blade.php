                        ...
                        <div class="swiper-slide">
                            <a href="{{ route_path('articles.show', $article) }}" class="alpha-trending-item">
                                ...
                                <span class="alpha-trending-item__body">
                                    ...
                                    @php
                                        $fakeRating = max(9.8, 10 - min($loop->index, 2) * 0.1);
                                    @endphp
                                    <ul class="alpha-trending-item__stats">
                                        <li><i class="fa fa-eye"></i> {{ number_format($article->view ?? 0) }}</li>
                                        <li>⭐ {{ number_format($fakeRating, 1) }}</li>
                                    </ul>
                                </span>
                            </a>
                        </div>
