                                ...
                                <header class="alpha-review-card__header">
                                    <div class="alpha-review-card__user">
                                        <div class="comment-header__ava image image-cover lazy-load-bg">
                                            <img class="lazy-image" loading="eager" src="{{ asset('static/core/images/alphanovel/default-avatar.jpg') }}" alt="{{ optional($comment->user)->name ?? optional($comment->user)->username }}">
                                        </div>
                                        <div>
